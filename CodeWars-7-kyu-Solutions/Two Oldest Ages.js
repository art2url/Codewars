...
// The array will always include at least 2 items. If there 
// are two or more oldest age, then return both of them in 
// array format.

function twoOldestAges(ages) {
    const sortedArr = ages.sort((a, b) => a - b);
    const lastAgesInArr = sortedArr.slice(-2);
    return lastAgesInArr;
}
